...
open class LoginAPI {
    ...
    open class func loginLoginAccessToken(password: String, username: String, clientId: String? = nil, clientSecret: String? = nil, grantType: String? = nil, scope: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> Token {
        return try await loginLoginAccessTokenWithRequestBuilder(password: password, username: username, clientId: clientId, clientSecret: clientSecret, grantType: grantType, scope: scope, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func loginLoginAccessTokenWithRequestBuilder(password: String, username: String, clientId: String? = nil, clientSecret: String? = nil, grantType: String? = nil, scope: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Token> {
